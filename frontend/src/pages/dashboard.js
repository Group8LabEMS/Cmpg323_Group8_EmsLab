  ...
  render(html`
    <div class="dashboard-flex">
      <div class="dashboard-row">
        <div class="card dashboard-card" style="min-width:420px;max-width:520px;">
          <div class="card-title"> ${currentMonth} ${year}</div>
        ...
        <div class="card dashboard-card" style="min-width:340px;max-width:420px;">
